...
//    ofEnableArbTex();
	...
	//ADD AN APP CLASS TO TESTAPP THAT CONTAINS EVERYTHING EXCEPT FOR THE KINECTMANAGER.
	//APP CLASS WILL HAVE ALL VARIABLES THAT KINECTMANAGER WILL NEED
	//EACH FRAME KINECTMANAGER WILL READ APP'S VARIABLES AND ASSIGN THE VALUES TO ITS RESPECTIVE VARIABLES
	//THIS WAY, GUI WILL NEVER NEED A REFERENCE TO KINECTMANAGER AND I CAN GET SOME FUCKING SLEEP
